...
import { IMAGE_WEB_RESOURCE_TYPES } from '../../services/webResources';
import type { WebResourceSummary } from '../../services/dataverseWebResourceService';
        ...
        <div className={styles.section}>
            ...
            {!connected && (
                <Text size={100} className={styles.hint}>
                    Browsing and uploading image web resources needs an active
