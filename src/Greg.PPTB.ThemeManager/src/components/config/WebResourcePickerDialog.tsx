 ...
 */
export function WebResourcePickerDialog({
    open,
    title,
    types,
    onDismiss,
    ...
    const load = useCallback(
        async (term: string) => {
            ...
            try {
                setItems(
                    await dataverseWebResourceService.listWebResources(
                        requestedTypes,
                        term
                    )
                );
