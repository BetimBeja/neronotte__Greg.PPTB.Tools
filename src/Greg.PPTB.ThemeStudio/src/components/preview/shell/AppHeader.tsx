...
function HeaderButton({
  ...
  const background = pressed
    ...
    : hovered
      ...
      : "transparent";
  const color = pressed
    ? colors.foregroundPressed
    : hovered
      ? colors.foregroundHover
      : colors.foreground;
...
export function AppHeader({
  ...
  return (
    <header
      ...
      data-themed="App header"
      aria-label="Sample app header"
    >
      ...
      <div className={styles.logo} title={tooltip}>
        {logoDataUri ? (
          <img className={styles.logoImage} src={logoDataUri} alt={tooltip} />
        ) : (
          <span className={styles.productName}>{tooltip}</span>
        )}
      </div>
